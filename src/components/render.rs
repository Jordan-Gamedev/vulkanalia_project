use crate::{ecs::Component, engine::{texture_engine::Material}};
...
impl Render {
    pub fn new(model_name: String, material: Material, receives_shadows: bool, casts_shadows: bool) -> Self {
        Self {
            model_name,
            material,
...
impl Component for Render {
    fn on_add(&mut self, world: &mut crate::ecs::World) {
        unsafe {
            ...
            app.load_model(self.model_name.clone()).unwrap();
        }
    }
