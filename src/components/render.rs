...
// use crate::{
//     engine::{ModelHandle, model_handle::QuantizedModelMatrix, texture_engine::Material},
//     resources::AssetId,
// };
...
//         unsafe {
//             let app = world.app.as_mut().unwrap();
//             let model_matrix = app
//                 .model_engine
//                 .get_model_matrix(self.get_model_matrix_index(), self.is_static());
//             Ok(model_matrix)
//         }
//     }

//     pub fn get_quantized_model_matrix_mut(
//         &self,
//         world: &crate::ecs::World,
//     ) -> Result<&mut QuantizedModelMatrix> {
//         unsafe {
//             let app = world.app.as_mut().unwrap();
//             let model_matrix = app
//                 .model_engine
//                 .get_model_matrix_mut(self.get_model_matrix_index(), self.is_static());
//             Ok(model_matrix)
//         }
//     }
...
//             self.set_model_matrix_index(
//                 ModelHandle::create_model_matrix(
//                     app,
...
//                 .unwrap(),
//             );
//             ModelHandle::create_instance(
//                 app,
//                 self.model_vertices,
//                 self.model_indices,
//                 self.material.albedo,
//                 self.material.sampler_contents,
//                 self.model_matrix_info,
//             )
//             .unwrap();
//         }
//     }
...
//                     == self.model_matrix_info
//                 {
//                     ModelHandle::remove_instance(
//                         app,
//                         self.model_vertices,
//                         self.model_indices,
//                         self.material.albedo,
//                         self.material.sampler_contents,
//                         app.command_engine.instance_buffer_mapped.add(i),
//                     )
//                     .unwrap();
//                     break;
//                 }
//             }
//             ModelHandle::remove_model_matrix(app, self.get_model_matrix_index(), self.is_static())
//                 .unwrap();
//         }
//     }
// }
